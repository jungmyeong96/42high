...
static void	screen_size(t_info *info, char *w, char *h)
{
	int	wh[2];
...
static void	check_arg(t_info *info, char *d)
{
...
static int	check_element(t_info *info, char **data)
{
