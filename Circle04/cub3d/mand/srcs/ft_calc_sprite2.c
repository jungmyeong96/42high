...
/*   Updated: 2021/03/31 21:41:36 by junghan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

void	put_color_in_spbuf(t_sprite *sprite, t_info *info, int x)
{
	int		y;
	...
	while (++y < sprite->drawend_y)
	{
		...
		sprite->tex_y = ((sprite->di * TEXHEI)
				/ sprite->sprite_hei) / 256;
		sprite->color = info->texture[4][TEXWID *
